...
# serializer that runs do_category_classification on the image when its uploaded
# class ExtractSubCategorySerializer(serializers.ModelSerializer):
#     # take the

'''
Handles Category classification by YOLOv8
- No deletion required as the image is not saved
'''
